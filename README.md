...
## The Stack
This project was built with a Flask sever framework. There is a SQL database that organizes and connects Users, Artists, and Locations connected through relational tables. SQL allowed for easy quering so that filters artists based on specific locations and then pulls information from the spotify API, using Spotipy (A python wrapper for this API).
